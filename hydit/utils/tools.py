...
def create_exp_folder(args, rank):
    ...
    existed_experiments = list(Path(args.output_dir).glob("*dit*"))
    ...
    experiment_dir = f"{args.output_dir}/{experiment_index:03d}-{model_string_name}"       # Create an experiment folder
