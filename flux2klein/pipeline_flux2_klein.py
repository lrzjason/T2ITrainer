...
from flux2klein.image_processor import Flux2ImageProcessor
from flux2klein.pipeline_output import Flux2PipelineOutput
...
class Flux2KleinPipeline(DiffusionPipeline, Flux2LoraLoaderMixin):
    ...
    Args:
        ...
        scheduler ([`FlowMatencode_promptchEulerDiscreteScheduler`]):
