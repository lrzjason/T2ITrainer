# Jason LI 20240625
# Copied from diffusers.pipelines.hunyuandit.pipeline_hunyuandit
# added SD3LoraLoaderMixin for training lora on windows
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        diffusers.     "Tencent-Hunyuan/HunyuanDiT-Diffusers", torch_dtype=torch.float16
        diffusers. )
        >>> pipe.to("cuda")
...
class HunyuanDiTPipeline(DiffusionPipeline, SD3LoraLoaderMixin):
    r"""
